...
| スキル | 用途 | 自動選択 | 使用頻度 |
|-------|------|---------|---------|
| **comprehensive-review** | 包括的レビュー（統合スキル） | ✅ `/review`時 | ⭐️⭐️⭐️⭐️⭐️ |
| └ `--focus=quality` | コード品質レビュー（旧 code-quality-review） | ✅ | ⭐️⭐️⭐️⭐️⭐️ |
| └ `--focus=security` | セキュリティ・エラー（旧 security-error-review） | ✅ | ⭐️⭐️⭐️⭐️⭐️ |
| └ `--focus=docs` | ドキュメント・テスト（旧 docs-test-review） | ✅ | ⭐️⭐️⭐️⭐️ |
| **uiux-review** | UI/UXレビュー | ✅ UI変更時 | ⭐️⭐️⭐️ |

**注**: 旧スキル名（code-quality-review等）も後方互換性のため引き続き使用可能（自動変換）
...
| スキル | 用途 | 使用タイミング |
|-------|------|---------------|
| **session-mode** | セッションモード切替 | 操作ガードの動作変更時 |
...
### Top 5（週1回以上）
1. **comprehensive-review** - 毎回の`/review`で使用（統合スキル、旧 code-quality-review/security-error-review/docs-test-review）
2. **backend-dev** - 言語別に毎日（統合スキル、旧 go-backend/typescript-backend）
3. **react-best-practices** - Reactプロジェクトで頻繁
