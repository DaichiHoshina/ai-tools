...
domain が独立している場合 (例: frontend / backend / infra) の調査は `explore-agent` を domain 数だけ同一 message で発火する。max 8。
...
- 並列数 max 8 (`parent + Dev×N ≤ 9` 制約、default 8、詳細: `references/PARALLEL-PATTERNS.md`)
