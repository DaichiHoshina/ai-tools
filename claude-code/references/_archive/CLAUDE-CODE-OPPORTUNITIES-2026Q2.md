# Claude Code Unadopted Features Tracking — 2026Q2 archive

`/claude-update-fix` Phase 3-B の再評価対象外。判定確定済み section の履歴参照用 archive で、active な track は `../CLAUDE-CODE-OPPORTUNITIES.md` を参照する。
