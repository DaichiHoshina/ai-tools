...
2. **Pre-Manager downgrade check** (static): `--sequential` 明示時のみ即 downgrade → 単一 `/dev` を delegate、PO/Manager をスキップ。それ以外 → step 3
