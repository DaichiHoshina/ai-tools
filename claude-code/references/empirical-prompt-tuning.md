...
残 commands (analytics / audit / docs / serena / serena-refresh / aliases / dashboard / claude-update-fix / flow / flow-auto / groove / git-pull / post-comment / design-doc / update-guidelines / test-local / ui / skill-add / skills-manage / reload) は局所利用 or 極小 shortcut で iter1 優先度低。次回以降は Codex review ループで P0/P1/P2 を消化する iter2 が候補。
