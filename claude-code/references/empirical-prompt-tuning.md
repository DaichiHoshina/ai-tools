...
全 21 skill + 主要 commands 17 件 + agents 7 件 iter1 適用完了 (2026-05-01)。
残 commands (analytics / audit / docs / serena / serena-refresh / aliases / dashboard / claude-update-fix / flow / flow-auto / groove / git-pull / post-comment / design-doc / update-guidelines / test-local / ui / skill-add / skills-manage / reload) は局所利用 or 極小 shortcut で iter1 優先度低。

iter2 着手: comprehensive-review (2026-05-01, 2 ループ収束) のみ。残 iter1 適用済み 46 件は使用頻度順 (post-tool-use 計測) で順次 iter2 候補。
