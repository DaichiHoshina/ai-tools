...
- 削除 8 カテゴリ: what 言い換え / PR 文脈依存 (チケット番号単独) / 自明アサーション / defensive 言い訳 / 主観評価 / テスト不確実 / 重複 / commented-out code
...
Self-review: 提出前に追加 comment を canonical 12 分類 table で自己分類し、削除 8 に該当するものを削除する。confidence < 80% の判定は discard する。
