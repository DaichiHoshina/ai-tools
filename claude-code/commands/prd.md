...
### Phase 4.5: writing レビュー自動実行

PRD はレビュワー・PM・開発者が読む共有ドキュメント。`/review --focus=writing` で文章品質を検査する。Critical 1件以上 or Warning 4件以上で書き直し必須（最大2 loop）。検出基準は `skills/comprehensive-review/SKILL.md` の writing 観点に定義済み。
