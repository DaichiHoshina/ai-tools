...
| 2. ガイドライン読込 | `guidelines/design/clean-architecture.md`, `domain-driven-design.md`, `references/design-doc-template.md` |
| 3. コード分析 | `mcp__serena__*` で既存シンボル・依存関係把握 |
| 4. draft 生成 | テンプレ12セクション（タイプ別調整、`references/design-doc-template.md` 準拠） |
