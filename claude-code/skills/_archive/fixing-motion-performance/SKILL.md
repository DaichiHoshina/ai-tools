...
description: Audit and fix animation performance issues (layout thrashing, compositor props, scroll-linked motion, blur). Use when animations stutter, transitions jank, or reviewing CSS/JS animation performance.
---
...
- for any non-default choice, state the constraint that justifies it (surface size, duration, or interaction requirement); prefer actionable notes and concrete alternatives over theory
