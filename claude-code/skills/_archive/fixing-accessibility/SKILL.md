...
description: Audit and fix HTML accessibility issues (ARIA, keyboard nav, focus, contrast, form errors). Use when adding interactive controls, forms, dialogs, or reviewing WCAG compliance.
---
