...
Boris Cherny 流 (howborisusesclaudecode.com) と公式 best practice (code.claude.com/docs/en/best-practices) の主要 tip を ai-tools の既存機能に照合する。実装方針が異なる箇所は「方針差」列に明記する。
