...
## 文章執筆ガイド (PR / commit / Slack / DesignDoc)

外部発信向け文章を書く・書き直す前に `guidelines/writing/README.md` を入口に参照。commit-message / pr-description / external-post / design-doc-protocol / auto-knowledge-update の 5 つ。
