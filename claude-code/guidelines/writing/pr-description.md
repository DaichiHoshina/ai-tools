...
設計判断を含む PR は「設計を選んだ理由」section を置き、論点ごとに h3 見出し + 段落 1-3 文で書く。対抗案を先に出してから却下理由をつなぐ (「〜という案もあった。ただし〜のため〜にした」)。
...
- 「Cursor 指摘反映」「Claude が生成」等の AI / tool 名の本文言及 (commit trailer の Co-Authored-By は残してよい)。修正理由は事実 (「発見性が高い」「既存 helper とまとめた方が自然」等) に言い換える
