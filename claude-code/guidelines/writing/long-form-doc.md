...
**prototype-first 運用 (Cagan 2024-2025)**: PRD 本文を厚くするより、clickable prototype / wireframe / 画面遷移図の link を本文中で参照する方が discovery を進めやすい。`## UX/UI仕様` には Figma / wireframe link を必ず置く。link が無い PRD は実装に入れない判断基準にする。
...
## AI prompt の引用記法 (Microsoft 2026 準拠)
