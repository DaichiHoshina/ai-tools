...
const board_manager_1 = require("./lib/board-manager");
const lock_manager_1 = require("./lib/lock-manager");
const archive_manager_1 = require("./lib/archive-manager");
const token_optimizer_1 = require("./lib/token-optimizer");
...
function getCurrentBoardId() {
    ...
    const result = (0, board_manager_1.findBoardByProject)(project_path);
    if (!result.ok) {
...
async function main() {
    ...
    switch (command) {
        case 'init': {
            ...
            const project_path = getCurrentProjectPath();
            const result = (0, board_manager_1.initBoard)(name, project_path);
            if (!result.ok) {
        ...
        case 'add': {
            ...
            const result = (0, board_manager_1.addTask)(board_id, title, { priority, description });
            if (!result.ok) {
                error(JSON.stringify(result.error));
            }
        ...
        case 'list': {
            ...
            const result = (0, board_manager_1.listTasks)(board_id, status ? { status } : undefined);
            if (!result.ok) {
                error(JSON.stringify(result.error));
            }
            ...
            const board = (0, token_optimizer_1.renderKanbanBoard)(result.value);
            console.log(board);
            process.exit(0);
            break;
        }
        case 'start': {
            ...
            const board_id = getCurrentBoardId();
            const result = (0, board_manager_1.updateTaskStatus)(board_id, task_id, 'in_progress');
            if (!result.ok) {
                error(JSON.stringify(result.error));
            }
        ...
        case 'move': {
            ...
            const board_id = getCurrentBoardId();
            const result = (0, board_manager_1.updateTaskStatus)(board_id, task_id, status);
            if (!result.ok) {
                error(JSON.stringify(result.error));
            }
        ...
        case 'done': {
            ...
            const board_id = getCurrentBoardId();
            const result = (0, board_manager_1.updateTaskStatus)(board_id, task_id, 'done');
            if (!result.ok) {
                error(JSON.stringify(result.error));
            }
        ...
        case 'show': {
            ...
            const board_id = getCurrentBoardId();
            const tasks_result = (0, board_manager_1.listTasks)(board_id);
            if (!tasks_result.ok) {
            ...
            const detail = (0, token_optimizer_1.renderTaskDetail)(task);
            console.log(detail);
            process.exit(0);
            break;
        }
        case 'boards': {
            const result = (0, board_manager_1.listBoards)();
            if (!result.ok) {
                error(JSON.stringify(result.error));
            }
        ...
        case 'archive': {
            ...
            const tasks_result = (0, archive_manager_1.getArchivedTasks)(board_id, date);
            if (!tasks_result.ok) {
                error(JSON.stringify(tasks_result.error));
            }
            ...
            // サマリー表示
            const summary_result = (0, archive_manager_1.getArchiveSummary)(board_id);
        ...
        case 'cleanup': {
            const board_id = getCurrentBoardId();
            const result = (0, lock_manager_1.cleanupExpiredLocks)(board_id);
            if (!result.ok) {
                error(JSON.stringify(result.error));
            }
        ...
        case 'auto-init': {
            const project_path = getCurrentProjectPath();
            const board_result = (0, board_manager_1.findBoardByProject)(project_path);
            if (!board_result.ok) {
            ...
            const init_result = (0, board_manager_1.initBoard)(name, project_path);
            if (!init_result.ok) {
        ...
        case 'status': {
            const board_id = getCurrentBoardId();
            const result = (0, board_manager_1.getBoardStatus)(board_id);
            if (!result.ok) {
                error(JSON.stringify(result.error));
            }
        ...
        case 'next': {
            const board_id = getCurrentBoardId();
            const result = (0, board_manager_1.getNextTask)(board_id);
            if (!result.ok) {
                error(JSON.stringify(result.error));
            }
            if (!result.value) {
        ...
        case 'progress': {
            const board_id = getCurrentBoardId();
            const result = (0, board_manager_1.getBoardProgress)(board_id);
            if (!result.ok) {
                error(JSON.stringify(result.error));
            }
        ...
        case 'split': {
            ...
            const result = (0, board_manager_1.splitTask)(board_id, task_id, subtasks);
            if (!result.ok) {
                error(JSON.stringify(result.error));
            }
        ...
        case 'block': {
            ...
            const board_id = getCurrentBoardId();
            const result = (0, board_manager_1.blockTask)(board_id, task_id, reason);
            if (!result.ok) {
                error(JSON.stringify(result.error));
            }
        ...
        case 'unblock': {
            ...
            const board_id = getCurrentBoardId();
            const result = (0, board_manager_1.unblockTask)(board_id, task_id);
            if (!result.ok) {
                error(JSON.stringify(result.error));
            }
